...
public class UpdatePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/updatepage.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(670, 537));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(roll.equals(""))
        {
            JOptionPane.showMessageDialog(this, "Roll number is not valid.");
        }
        else if(name.equals("") && address.equals("") && phno.equals(""))
        {
            JOptionPane.showMessageDialog(this, "Please pass any value in name , address and phone number.");
        }
        else
        {
            if(name.equals(""))
            {
                ...
                name = service.UpdateService.getName(roll);
            ...
            if(address.equals(""))
            {
                address = service.UpdateService.getAddress(roll);
                System.out.println(address);
            }
            
            if(phno.equals(""))
            {
                phno = service.UpdateService.getPhone(roll);
                System.out.println(phno);
                
            }
            boolean bb = service.UpdateService.update(name, address , roll, phno);
            if(bb) 
            {
