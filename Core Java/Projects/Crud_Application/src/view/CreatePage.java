...
public class CreatePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("If already a user ");
        ...
        setSize(new java.awt.Dimension(549, 417));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!name.equals(""))
        {
            ...
            {
                JOptionPane.showMessageDialog(this, "Password field can't be null.");
            }
            else
            {
                if(pass.equals(pass2))
                {
                    boolean bb = service.CreateService.Create(name, pass);
                    if(bb)
                    {
                        JOptionPane.showMessageDialog(this, "Creation successfully.");
                        setVisible(false);
